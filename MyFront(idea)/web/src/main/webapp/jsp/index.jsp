...
<div class="container main-content">
    ...
    <div class="unit">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-sm-offset-1">
            <p>昵称：小潘</p>
            <p>性别：男</p>
            <p>年龄：<%=TimeUtils.getIntervalByNow("1993-01-01 00:00:00", ConstUtil.TimeUnit.DAY) / 365%>
            </p>
            <p>学历：本科</p>
            <p>学校：北京航空航天大学北海学院</p>
            <p>专业：计算机科学与技术</p>
    ...
    <div class="unit news col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="news-bg col-md-12 col-sm-12 col-xs-12">
            <a href="#" target="_blank">
                <div class="col-md-10 col-sm-10 col-xs-10 news-title news-title-color">
                    <strong class="">[java]我努力工作</strong>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-2 news-time news-title news-title-color">
