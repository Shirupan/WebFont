...
<%@ page import="com.sl.utils.ConstUtil" %>
<%
...
<head>
    ...
    <%--garlly:start--%>
    <link href="/css/gallery/chocolat.css" rel="stylesheet" type="text/css" media="screen"
          charset="utf-8">
...
<script src="/js/gallery/jquery.chocolat.js"></script>
