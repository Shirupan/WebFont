...
public class TimeUtils {
    ...
    public static void main(String[] args) {
        System.out.println(TimeUtils.getIntervalByNow("2015-09-06 09:17:24", ConstUtil.TimeUnit.DAY));

        System.out.println(getCurTimeYear());
    }
}